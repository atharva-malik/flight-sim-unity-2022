...
namespace UnityStandardAssets.Vehicles.Aeroplane
{
    ...
    public class MyAeroplaneController : MonoBehaviour
    {
        ...
        [SerializeField] private float m_MaxThrottle = 100f; // how much drag should increase with speed.
        ...
        private void ControlThrottle()
        {
            ...
            if (Input.GetKey(KeyCode.I) && Throttle < m_MaxThrottle){
                Throttle += m_ThrottleChangeSpeed*Time.deltaTime;
            }else if (Input.GetKey(KeyCode.K) && Throttle > -0.7){
                Throttle -= m_ThrottleChangeSpeed*Time.deltaTime;
            }
